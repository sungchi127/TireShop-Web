...
const tireSeriesData = [
  { name: 'Potenza', description: '極致駕馭的性能胎款，專為追求操控樂趣的您設計。', slogan: '極致駕馭', image: '/images/potenza.jpeg' },
  { name: 'Turanza', description: '提供奢華舒適的駕乘體驗，適合長途旅行與日常通勤。', slogan: '奢華舒適', image: '/images/turanza.jpeg' },
  { name: 'Alenza', description: '專為都會頂級SUV打造，兼顧操控性與舒適性。', slogan: '都會頂級SUV', image: '/images/alenza.jpeg' },
  { name: 'Ecopia', description: '節能環保的王者，有效降低油耗並提升續航里程。', slogan: '節能王者', image: '/images/ecopia.jpeg' },
  { name: 'Dueler', description: '專為SUV設計，提供卓越的越野性能與耐用性。', slogan: 'SUV專用', image: '/images/dueler.jpeg' },
