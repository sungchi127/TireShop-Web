...
const AboutPage = () => {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>關於我們 - 廣翊輪胎行</title>
        <meta name="description" content="了解廣翊輪胎行的故事、服務、聯絡方式與位置" />
      </Head>

      <section className={styles.hero}>
        <h1 className={styles.pageTitle}>關於廣翊輪胎行</h1>
      ...
      <section className={styles.contentSection}>
        <h2>我們的故事</h2>
        <p>
          廣翊輪胎行深耕本地市場多年，致力於提供各大品牌優質輪胎與最專業的安裝、保養服務。
