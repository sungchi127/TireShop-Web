  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="輪胎訂購服務。請注意：線上訂購功能暫未開放，請透過電話聯繫。" />
      </Head>
      ...
      <form onSubmit={handleSubmit} className={`${styles.orderForm} ${styles.formDisabledVisuals}`}>
        <fieldset className={styles.fieldset}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className={styles.input} required disabled />
          </div>
          <div className={styles.formGroup}>
            <label htmlFor="phone" className={styles.label}>聯絡電話 <span className={styles.required}>*</span></label>
            <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} className={styles.input} required disabled />
          </div>
          <div className={styles.formGroup}>
            <label htmlFor="email" className={styles.label}>電子郵件</label>
            <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className={styles.input} disabled />
          </div>
        </fieldset>
        ...
        <fieldset className={styles.fieldset}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" id="tireBrandSeries" name="tireBrandSeries" value={formData.tireBrandSeries} onChange={handleChange} className={styles.input} placeholder="例如：普利司通 Potenza S007A" disabled />
          </div>
          <div className={styles.formGroup}>
            <label htmlFor="tireSpecs" className={styles.label}>輪胎規格</label>
            <input type="text" id="tireSpecs" name="tireSpecs" value={formData.tireSpecs} onChange={handleChange} className={styles.input} placeholder="例如：225/45R18 (若不確定可留空)" disabled />
          </div>
          <div className={styles.formGroup}>
            <label htmlFor="quantity" className={styles.label}>數量 <span className={styles.required}>*</span></label>
            <input type="number" id="quantity" name="quantity" value={formData.quantity} onChange={handleChange} className={styles.input} min="1" required disabled />
          </div>
        </fieldset>
        ...
        <fieldset className={styles.fieldset}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" id="carMake" name="carMake" value={formData.carMake} onChange={handleChange} className={styles.input} placeholder="例如：Toyota" disabled required />
          </div>
          <div className={styles.formGroup}>
            <label htmlFor="carModel" className={styles.label}>車輛型號<span className={styles.required}>*</span></label>
            <input type="text" id="carModel" name="carModel" value={formData.carModel} onChange={handleChange} className={styles.input} placeholder="例如：Corolla Altis" disabled required />
          </div>
          <div className={styles.formGroup}>
            <label htmlFor="carYear" className={styles.label}>車輛年份</label>
            <input type="text" id="carYear" name="carYear" value={formData.carYear} onChange={handleChange} className={styles.input} placeholder="例如：2020" disabled />
          </div>
        </fieldset>
          ...
          <div className={styles.formGroup}>
            ...
            <div className={styles.radioGroup}>
              <label className={styles.radioLabel}>
                <input type="radio" name="needsInstallation" value="yes" checked={formData.needsInstallation === 'yes'} onChange={handleInstallationChange} disabled /> 是
              </label>
              <label className={styles.radioLabel}>
                <input type="radio" name="needsInstallation" value="no" checked={formData.needsInstallation === 'no'} onChange={handleInstallationChange} disabled /> 否
              </label>
            </div>
          </div>
          {formData.needsInstallation === 'yes' && (
            <>
              <div className={styles.formGroup}>
                ...
                <input type="date" id="appointmentDate" name="appointmentDate" value={formData.appointmentDate} onChange={handleChange} className={styles.input} disabled />
              </div>
              <div className={styles.formGroup}>
        ...
        <fieldset className={styles.fieldset}>
          ...
          <div className={styles.formGroup}>
            ...
            <textarea id="notes" name="notes" value={formData.notes} onChange={handleChange} className={styles.textarea} rows="4" placeholder="例如：是否有現貨？大概多久可以調到貨？" disabled></textarea>
          </div>
        </fieldset>
